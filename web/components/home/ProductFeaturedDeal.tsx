...
export function ProductFeaturedDeal() {
  return (
    <div className="product-featured">
      ...
      <div className="showcase-wrapper has-scrollbar">
        <div className="showcase-container">
          <div className="showcase">
            <div className="showcase-banner">
              <img src={A("images/products/shampoo.jpg")} alt="shampoo, conditioner & facewash packs" className="showcase-img" />
            </div>
        ...
        <div className="showcase-container">
          <div className="showcase">
            <div className="showcase-banner">
              <img src={A("images/products/jewellery-1.jpg")} alt="Rose Gold diamonds Earring" className="showcase-img" />
            </div>
            <div className="showcase-content">
              <div className="showcase-rating">
                <IonIcon name="star" />
